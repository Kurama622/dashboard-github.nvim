...
-- All credits to https://github.com/nvzone/volt for making this!
...
M.hex2rgb = function(hex)
  ...
  local r =
    tonumber(hex:sub(2 - (hash and 0 or 1), 3 - (hash and 0 or 1)), 16)
  local g =
    tonumber(hex:sub(4 - (hash and 0 or 1), 5 - (hash and 0 or 1)), 16)
  local b =
    tonumber(hex:sub(6 - (hash and 0 or 1), 7 - (hash and 0 or 1)), 16)
  return r, g, b
end
...
M.hex2rgb_ratio = function(hex)
  ...
  return math.floor(r / 255 * 100),
    math.floor(g / 255 * 100),
    math.floor(b / 255 * 100)
end
